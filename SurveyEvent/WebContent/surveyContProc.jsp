			...
			<div id="formBox">
				...
				<%
					...
					<%
						for(int j=0;j<10;j++){
							if(a[i][j]!=null){%>
							<input type="radio" name="<%="q"+(i+1)%>" value="<%=(j+1)%>" required> <%=a[i][j] %><br>
							<%}
						}
					}
				%>
				<br><input id="upload" type="submit" value="제출하기"><br>
			</div>
		</form>
	</div><br>
</body>
